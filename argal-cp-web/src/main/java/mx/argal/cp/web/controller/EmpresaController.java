...
import mx.argal.cp.servicios.EmpresaServicio;
...
public class EmpresaController {
	...
	@RequestMapping(value="/getempresasactivas",method = RequestMethod.POST)
    @ResponseBody
    public List<Empresa> obtenerEmpresas(){
		System.out.println("<OTIKA>GetIcds");
		try{
			return this.empresaServicio.obtenerEmpresasActivas();
		}
		catch(Exception e){
		}
