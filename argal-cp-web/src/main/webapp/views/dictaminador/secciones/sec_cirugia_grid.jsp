...
<div id="detailsDialog">
    <form id="detailsForm">
        ...
        <div class="details-form-field">
            ...
            <input id="honorariosMedicosDictaminados" name="honorariosMedicosDictaminados" type="text" /> <br>Aplicar: <input style="width:50px" id="porcHM" name="porcHM" type="number" value="30" onchange="actualizarHonorarios(1);"/>%
        </div>
        <div class="details-form-field">
            <label for="honorariosAyudanteUnoDictaminados">Honorarios Ayudante 1:</label>
            <input id="honorariosAyudanteUnoDictaminados" name="honorariosAyudanteUnoDictaminados" type="text" /><br>Aplicar: <input style="width:50px"id="porcA1" name="porcA1" type="number" value="15" onchange="actualizarHonorarios(2);"/>%
        </div>
        <div class="details-form-field">
        ...
        <div class="details-form-field">
            ...
            <input id="honorariosAnestesiologoDictaminados" name="honorariosAnestesiologoDictaminados" type="text" /><br>Aplicar: <input style="width:50px"id="porcAN" name="porcAN" type="number" value="15" onchange="actualizarHonorarios(4);" />%
        </div>
        <div class="details-form-field">
