		...
		<div id="contentContainer" class="clearfix" align="center">
			...
			<section id="pageSection" >			
			  <div class="form-group">
			  	<h5><img src="../../static/img/v2.0/img/agregarhospital.jpg" height="37" width="37" id="imgImplants" name="imgImplants"/>CATÁLOGO DE HOSPITALES
			  		
			  		<br><a href="#" onclick="agregarHospitalShow()"><img src="../../static/img/v2.0/img/agregarhospital.png" height="32" width="32" id="imghosp2" name="imghosp2"/>Nuevo Hospital</a>
			  	</h5>
			  	
			    <form id="allhopsform" name="allhopsform" class="register f1" method="post">
