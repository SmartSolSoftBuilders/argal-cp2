...
<br>
<button id="buttonvalidaridentidad" width="200px" height="100px" class="myButton" onclick="validarIdentidad()" >Validar Identidad</button>
<br><br>
...
<div id="nuevoPswCk">
	...
	<br>
	<br>														  	
	<button id="guardarNuevoPswBt" name="guardarNuevoPswBt" class="myButton" onclick="guardarPswNuevo()" >Guardar</button>
</div>
</div>
