<br><a href="#" onclick="limpiarCamposNuevoMedTrat(),agregarMedTratShowFromEvento()"><img src="../../static/img/v2.0/img/agregarimplants.png" height="37" width="37" id="imgImplants2" name="imgImplants2"/>Nuevo Médico Tratante</a>
