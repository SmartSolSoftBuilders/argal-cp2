...
<table style="background-color:rgba(0, 0, 0, 0.13);">
	<tr>
		...
		<h5>Por favor llene cada sección de la información solicitada.
		Puede llenar una sección y guardarla para enviarla después.</h5>
		</td>
	</tr>
</table>
<style>
				...
				<form method="POST" action="contact-form-submission.php"
					...
					<table border=1>
						<tr>
							<td>
								<div class="control-group">
									<label class="control-label" for="name">Diagnóstico de Ingreso 1:</label>
									<div class="controls">
